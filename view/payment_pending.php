...
<div class="bg-white p-2">
    <div class="text-center w-full p-4 flex flex-col gap-y-8">
        ...
        <img alt="" class="mx-auto" height="auto" src="http://9pl9.mjt.lu/tplimg/9pl9/b/ygjj/t65lu.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:30%;" title="">
        <a href="https://oembah.xyz/view/welcome_page.php" type="button" class="text-white mx-auto bg-[#C27D2B] hover:bg-[#c27619] focus:ring-4 focus:ring-[#b06e1e] font-medium rounded-full text-xs sm:text-sm px-4 py-2.5 text-center">Dashboard</a>
