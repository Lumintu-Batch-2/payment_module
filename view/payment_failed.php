...
<div class="bg-white p-2">
    <div class="text-center w-full p-4 flex flex-col gap-y-8">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-36 w-36 mx-auto" fill="none" viewBox="0 0 24 24" stroke="#A02724" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <a href="https://oembah.xyz/view/welcome_page.php" type="button" class="text-white mx-auto bg-[#C27D2B] hover:bg-[#c27619] focus:ring-4 focus:ring-[#b06e1e] font-medium rounded-full text-xs sm:text-sm px-4 py-2.5 text-center">Buat pesanan baru</a>
