            ...
            <div class="bg-white rounded-lg shadow relative">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="flex space-x-2 items-center p-6 rounded-b mx-auto mr-0">
                        ...
                        <button type="button" class="text-white bg-[#C27D2B] hover:bg-[#c27619] focus:ring-4 focus:ring-[#b06e1e] font-medium rounded-lg text-sm px-5 py-2.5 text-center " onclick="createOrder()">Bayar sekarang</button>
                    </div>
                </div>
